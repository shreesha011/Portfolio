    ...
    export default function MyPortfolio() {
      ...
      const handleGithubButtonClick1 = () => {
        // Replace "your-github-username" with your actual GitHub username
        const githubLink = 'https://github.com/shreesha011';
        window.open(githubLink, "_blank");
      }

      const handleGithubButtonClick2 = () => {
        // Replace "your-github-username" with your actual GitHub username
        const githubLink = 'https://github.com/shreesha011?tab=repositories';
        window.open(githubLink, "_blank");
      }
      ...
      return (
        <section className="portfolio--section" id="MyPortfolio">
          ...
          {/* Visit by Github Button */}
            <div>
              <button className="btn btn-github" onClick={handleGithubButtonClick1} >
                <svg
              ...
              <div key={index} className="portfolio--section--card">
               ...
               {/*  */}
                <div className="portfolio--section--card--content">
                  ...
                  <p className="text-sm portfolio--link" onClick={handleGithubButtonClick2}>
                    {item.link}
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
