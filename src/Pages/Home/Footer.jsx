  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div>
          <img src="./img/feather-pen-1.png" alt="Logoipsum" />
        </div>
        ...
        <div className="footer--social--icon">
          ...
          <li>
              <a
                href="https://www.linkedin.com/in/shreesha-shinganmalli/"
           ...
           <li>
            ...
            <li>
              <a
                href="https://www.facebook.com/shreesha.shinganmalli"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Shreesha</p>
